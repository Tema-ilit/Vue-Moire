Добрый день, я начинающий веб разработчик и я написал интернет магазин, стилизация может показаться невзрачной, но она выдержана в рамках тз, основная цель это взаимодейсвтие с фреймворком vue.
